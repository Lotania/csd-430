...
<!-- The alterations are in each separate page. This page lets you choose which record to view -->
<ul>
...
<h2>Table Reset</h2>
<p>Use this button to reset the Database table to its original records.</p>
<!-- This is in case you want to see the original table -->
<form action="execute-sql" method="post">
    <button type="submit">Reset SQL table</button>
</form>
